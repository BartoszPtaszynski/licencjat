...
1. Należy stworzyć lokalnie bazę danych o nazwie `club_career`.
2. uruchomić na utworzonej bazie kod SQL, który jest zawarty w pliku w projekcie o nazwie `kodBazyDanych.sql`.
